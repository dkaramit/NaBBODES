...
void Ros<N_eqs, RK_method, LD>::sum_ak(const unsigned int& stage){
...
/*-----------------------Begin: sum_gk---------------------------------*/
template<unsigned int N_eqs, class RK_method, class LD> 
void Ros<N_eqs, RK_method, LD>::sum_gk(const unsigned int& stage){
...
/*-----------------------Begin: sum_bk---------------------------------*/
template<unsigned int N_eqs, class RK_method, class LD> 
void Ros<N_eqs, RK_method, LD>::sum_bk(){
